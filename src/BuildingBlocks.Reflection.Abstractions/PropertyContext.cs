...
{
    public abstract class PropertyContext : IPropertyContext
    {
        ...
        public TValue GetValue<TTarget, TValue>(ref TTarget target, string name)
        {
            ...
            static void ThrowKeyNotFound(Type targetType, string name)
                => throw new KeyNotFoundException($"Cannot find generated property getter {name} in {targetType.Name}.");
        }
        ...
        public void SetValue<TTarget, TValue>(ref TTarget target, string name, TValue value)
        {
            ...
            [DoesNotReturn]
            static void ThrowKeyNotFound(Type targetType, string name)
                => throw new KeyNotFoundException($"Cannot find generated property setter {name} in {targetType.Name}.");
        }
    }
}
